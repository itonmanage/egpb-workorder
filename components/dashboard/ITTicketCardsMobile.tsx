...
interface ITTicketCardsMobileProps {
    tickets: Ticket[];
    loading: boolean;
}

/**
 * Mobile/Tablet card view for IT Dashboard tickets
 ...
 */
export default function ITTicketCardsMobile({ tickets, loading }: ITTicketCardsMobileProps) {
    // Loading skeleton
    if (loading) {
        return (
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-start gap-2">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-sm text-gray-900 truncate">{ticket.location}</p>
                            </div>
                        </div>
