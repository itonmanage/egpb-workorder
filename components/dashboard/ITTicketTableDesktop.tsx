...
interface ITTicketTableDesktopProps {
    tickets: Ticket[];
    loading: boolean;
    hasFilters: boolean;
    onCreateClick: () => void;
...
/**
 * Desktop table view for IT Dashboard tickets
 * Displays tickets in a full table layout with all columns
 * 
 * Features:
 ...
 */
export default function ITTicketTableDesktop({
    tickets,
    loading,
    hasFilters,
    onCreateClick
}: ITTicketTableDesktopProps) {
                        ...
                        <tr>
                            <td colSpan={9} className="p-0">
                                <EmptyState
                                    ...
                                    description={hasFilters ? 'Try adjusting your search or filter criteria' : 'Create your first ticket to get started'}
                                    action={!hasFilters ? {
                                        label: 'Create Ticket',
