...
export async function PATCH(
  ...
  try {
    ...
    // Only ADMIN and IT_ADMIN can update IT tickets
...
export async function DELETE() {
  // Policy Enforcement: Ticket deletion is disabled by system design.
  // Admins should Cancel tickets instead of deleting them.
  return NextResponse.json(
    { error: 'Method not allowed. Ticket deletion is disabled by policy.' },
    { status: 405 }
  );
}
